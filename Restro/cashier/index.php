...
<body class="bg-dark">
  <div class="main-content">
    ...
    <div class="container mt--8 pb-5">
      <!-- Main container with custom top margin (mt--8) and bottom padding (pb-5) -->
      <div class="row justify-content-center">
         <!-- Row to center the content horizontally -->
        <div class="col-lg-5 col-md-7">
          <!-- Column that takes 5 out of 12 parts on large screens and 7 out of 12 on medium screens -->
          <div class="card bg-secondary shadow border-0">
             <!-- Card component with a secondary background, shadow, and no border -->
            <div class="card-body px-lg-5 py-lg-5">
              <!-- Card body with horizontal and vertical padding on large screens -->
              <form method="post" role="form">
                <div class="form-group mb-3">
                  <!-- Form group for the email input with margin-bottom (mb-3) -->
                  <div class="input-group input-group-alternative">
                    <div class="input-group-prepend">
                        <!-- Prepended element (icon) for the input group -->
                       <span class="input-group-text"><i class="ni ni-email-83"></i></span>
                    </div>
                    <input class="form-control" required name="staff_email" placeholder="Email" type="email">
                    <!-- Email input field with required attribute and placeholder -->
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <!-- Password input field with required attribute and placeholder -->
                  </div>
                </div>
