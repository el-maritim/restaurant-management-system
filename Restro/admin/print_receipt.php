<?php
session_start();// Start the session for maintaining user state and data
...
<?php
// Retrieve the order code from the URL's query parameter
$order_code = $_GET['order_code'];
// SQL query to fetch the order details from the database
        ...
        <div class="container">
            <div class="row">
                ...
                <div id="Receipt" class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    <!--the well class creates a container with a slightly inset appearance and a light background.-->
                    <div class="row">
                        <!--xs extra small screen sm small screen medium screen - responsive design -->
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <address>
                                <strong>Elite Lounge</strong>
                                <br>
                                127-0-0-1
                                <br>
                                45373 Lavington, Nairobi
                                <br>
                                +254 719 126 874
                            </address>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>   </td>
                                    <td>   </td><!--non breaking space &nbsp a space char that cannot be broken into a new line-->
                                    <td class="text-right">
                                        <p>
...
<script>
    function printContent(el) {
        var restorepage = $('body').html();// Backup the current page content
        var printcontent = $('#' + el).clone();// Clone the receipt content
        $('body').empty().html(printcontent);// Replace page content with the receipt
        window.print(); // Open the print dialog
        $('body').html(restorepage);// Restore the original page content
    }
</script>
<?php } ?>