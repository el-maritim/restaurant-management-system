                ...
                <div class="form-row">
                  ...
                  <div class="col-md-4">
                    ...
                    <select class="form-control" name="customer_name" id="custName" onChange="getCustomer(this.value)">
                      ...
                      <?php
                      //Load All Customers
                      $ret = "SELECT * FROM  rpos_customers ";//A dropdown list allows selecting the customer's name from the rpos_customers table.
                  ...
                  <div class="col-md-4">
                    <label>Customer ID</label><!--customer_id is auto-filled using JavaScript (via the getCustomer() function)-->
                    <input type="text" name="customer_id" readonly id="customerID" class="form-control">
                  </div>

                  <div class="col-md-4">
                    <label>Order Code</label><!--An order_code is generated dynamically using PHP variables like $alpha and $beta-->
