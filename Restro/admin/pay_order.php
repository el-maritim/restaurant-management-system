...
if (isset($_POST['pay'])) {
  ...
  if (empty($_POST["pay_code"]) || empty($_POST["pay_amt"]) || empty($_POST['pay_method'])) {//Check for blank form inputs
    ...
    //Insert Captured information to a database table. Prepare SQL statements for insertion and update
   ...
   //executes the queries
    ...
    if ($upStmt && $postStmt) {
      $success = "Paid" && header("refresh:1; url=receipts.php");// Check execution success and provide user feedback
    } else {
      $err = "Please Try Again Or Try Later";// Display error message on failure
    }
  }
}
...
<body>
  ...
  <div class="main-content">
    ...
    $order_code = $_GET['order_code']; // Fetch order details using the order code from the URL
            ...
            <div class="card-body">
              <form method="POST"  enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="col-md-6"><!--col.. for responsive behaviour..md medium devices, lg large devices,sm small devives-->
                    <!--col not for visual design is for layout design-->
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <label>Amount ($)</label> <!-- Payment Amount (read-only) -->
