...
<body>
  ...
  <div class="main-content">
   ...
   <div style="background-image: url(assets/img/theme/restro00.jpg); background-size: cover;" class="header  pb-8 pt-5 pt-md-8">
    ...
    <!-- Page content -->
    <div class="container-fluid mt--7"><!--inner-->
      <div class="row mt-5">
          ...
          <div class="card shadow">
            ...
            <div class="table-responsive"><!--table-->
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <?php
                  //Fetches and displays the last 7 orders from the rpos_orders table.
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php if ($order->order_status == '') {//Checks if the order_status property of the $order object is empty
                            echo "<span class='badge badge-danger'>Not Paid</span>";//you can...
                          } else {
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      <th class="text-success" scope="row"><!--you can..-->
